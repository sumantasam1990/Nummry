@include('layouts.header', ['title' => '500 Error'])
<style>
...
<div class="main-error-page">
    ...
    >
        ...
        <g fill="none" fill-rule="evenodd">
            <path fill="#FAFAFA" d="M0 0H1366V800H0z" transform="translate(-448 -158)" />
            <g>
    ...
    <h2 class="error-subtitle">
        Please contact to <a href="mailto:hello@nummry.com">hello@nummry.com</a>.
    </h2>
