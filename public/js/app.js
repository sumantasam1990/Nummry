...
/*!*****************************!*\
  !*** ./resources/js/app.js ***!
  \*****************************/
var Timer = (__webpack_require__(/*! easytimer.js */ "./node_modules/easytimer.js/dist/easytimer.js").Timer);
...
timerInstance.start({
  callback: function callback(timer) {
    ...
    document.cookie = "seconds=" + timer.getTimeValues().toString(['seconds']) + "; path=/;"; // console.log(timer.getTimeValues().toString(['hours', 'minutes', 'seconds']))
  },
  startValues: {
    hours: hr,
    minutes: min,
...
var pause = document.getElementById('pause_time');
var resume = document.getElementById('resume_time');
